...
select_aux_forwardFMI_simstudy <- function(Y, aux_dat, scenario, print = FALSE){
  ...
  last_diff <- 100
  if(scenario == "n250_p25_pmy30_mod"){ frac <- 0.01 * pmy} 
  if(scenario == "n250_p83_pmy30_mod"){ frac <- 0.01 * pmy} 
  if(scenario == "n1000_p100_pmy30_mod"){ frac <- 0.01 * pmy} 
  if(scenario == "n1000_p333_pmy30_mod"){ frac <- 0.005 * pmy} 
  if(scenario == "n1000_p100_pmy50_mod"){ frac <- 0.01 * pmy} 
  if(scenario == "n1000_p100_pmy30_str"){ frac <- 0.01 * pmy} 
